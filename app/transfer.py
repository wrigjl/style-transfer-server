...
plt.figure()
imshow(style_img, title="Style Image", fname="style.jpg")

plt.figure()
imshow(content_img, title="Content Image", fname="content.jpg")
...
plt.figure()
imshow(input_img, title="Input Image", fname="input.jpg")
